...
#include "fonts/OpenSansCondensed12pt7b.h"
#include <Fonts/FreeSerifBold12pt7b.h>

//#include "fonts/RobotoBold15pt7b.h"
//#include "fonts/RobotoCondensedBold15pt7b.h"
#include "fonts/OpenSansCondensed15pt7b.h"
...
const char EPD_SoftRF_text1[] = "SoftRF-pcl";

const char EPD_Info1_max_len[] = "XXXXXXX ";
...
static uint8_t softrf_icon_128x128[] PROGMEM = {
// 'airplane-128', 128x128px, converted with https://javl.github.io/image2cpp/
...
,
...
,
...
static void EPD_logo(const char* msg)
{
  uint16_t x, y, tbw, tbh, display_width, display_height;
  int16_t  tbx, tby;
  int16_t  dy = 0;
  char buf[32];
  ...
  display->setFont(&OpenSansCondensed12pt7b);

#if defined(EPD_ASPECT_RATIO_1C1)
  x = (display_width  - 128) / 2;
  y = (display_height - 128) / 2 - tbh / 2 + dy;
  display->drawBitmap(x, y, softrf_icon_128x128, 128, 128, GxEPD_BLACK);
#endif /* EPD_ASPECT_RATIO_1C1 */

  snprintf(buf, sizeof(buf), "%s %s", EPD_SoftRF_text1, SOFTRF_FIRMWARE_VERSION);
  ...
  snprintf(buf, sizeof(buf), "HW: %s", hw_info.revision > 2 ?
...
//    while (!SoC->Display_lock()) { delay(10); }
    ...
    display->getTextBounds(EPD_Info1_max_len, 0, 0, &tbx, &tby, &tbw, &tbh);
    ...
    display->print(hw_info.rf != RF_IC_NONE ? "+" : "n/a");
    ...
    display->setCursor(x + tbw, y);
    display->print(hw_info.gnss != GNSS_MODULE_NONE ? "+" : "n/a");
    ...
    if (hw_info.model == SOFTRF_MODEL_BADGE) {
      ...
      display->setCursor(x + tbw, y);
      display->print(hw_info.display != DISPLAY_NONE ? "+" : "n/a");
      ...
      display->setCursor(x + tbw, y);
      display->print(hw_info.rtc != RTC_NONE ? "+" : "n/a");
      ...
      display->setCursor(x + tbw, y);
      display->print(hw_info.storage == STORAGE_FLASH ? "+" : "n/a");
      ...
      display->setCursor(x + tbw, y);
      display->print(hw_info.storage == STORAGE_CARD  ? "+" : "n/a");
    }
